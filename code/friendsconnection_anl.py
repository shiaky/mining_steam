...
oPlot.get_figure().savefig(sImageDirectory + "friendsconn_1.png")
plt.clf()
...
oPlot.get_figure().savefig(sImageDirectory + "friendsconn_2.png")
plt.clf()
...
oPlot.fig.savefig(sImageDirectory + "friendsconn_3.png")
plt.clf()
...
oPlot.set_axis_labels("mean friends connection", "number of friends")
oPlot.fig.savefig(sImageDirectory + "friendsconn_4.png")
plt.clf()
